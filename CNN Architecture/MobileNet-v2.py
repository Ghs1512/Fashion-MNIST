...
# Function to extract features using MobileNetV2 model
def extract_features(img_path):
    try:
        img = image.load_img(img_path, target_size=(224, 224))  # MobileNetV2 requires 224x224 input
...
np.save("D:\\ASEB\\AI\\MNv2_features_pls_work.npy", X)
np.save("D:\\ASEB\\AI\\MNv2_labels_pls_work.npy", y)
